...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		//Create the unfolding second map, setting its position and its magnitude
		map2 = new UnfoldingMap(this, 450, 50, 350, 500, provider2);
		//Setting its zoom level and the location
		map2.zoomAndPanTo(zoomLevel, new Location(37.18f, -3.63f));
